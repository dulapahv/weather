...
// Response can be cached for 5 minutes, and stale responses can be served for up to 10 minutes
// while revalidating in the background.
export const WEATHER_CACHE_CONTROL = 'public, s-maxage=300, stale-while-revalidate=600';
// Response can be cached for 1 day, and stale responses can be served for up to 7 days while
...
export const jsonResponse = <T>(data: T, init: JsonInit = {}) => {
