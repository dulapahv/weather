...
// Only the units Open-Meteo actually applies go in the key. Distance/pressure are converted
// client-side, so changing them reformats without a refetch.
export const buildWeatherKey = (coords: Coordinates, units: Units): string => {
