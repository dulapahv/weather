...
// Open-Meteo returns temperature/wind/precipitation already in the requested unit, but
// pressure (hPa) and visibility (m) are fixed, so those convert on the client.
